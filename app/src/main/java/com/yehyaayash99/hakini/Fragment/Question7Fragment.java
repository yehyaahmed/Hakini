...
public class Question7Fragment extends Fragment {
    ...
    ImageView question7Choose1IV, question7Choose2IV,
            question7Selected1IV, question7Selected2IV;

    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.question7_layout, container, false);
        init(view);

        checkSelect();

        question7Choose1IV.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                QuestionsActivity.number7 = 1;
                checkSelect();
                ...
                new Handler().postDelayed(new Runnable() {
                    @Override
                    public void run() {
                        getFragmentManager().beginTransaction().replace(R.id.fragment_container, new Question8Fragment()).commit();                    }
                }, 1000);
            }
        });

        question7Choose2IV.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                QuestionsActivity.number7 = 2;
                checkSelect();
                QuestionsActivity.positionFragment++;
                makeChangeInItems(QuestionsActivity.positionFragment);
                new Handler().postDelayed(new Runnable() {
    ...
    private void checkSelect() {
        switch (QuestionsActivity.number7) {
            case 1:
                question7Selected1IV.setVisibility(View.VISIBLE);
                question7Selected2IV.setVisibility(View.GONE);


                QuestionsActivity.question7Result = "نعم";
                break;
            case 2:
                question7Selected1IV.setVisibility(View.GONE);
                question7Selected2IV.setVisibility(View.VISIBLE);

                QuestionsActivity.question7Result = "لا";
                break;
            default:
                question7Selected1IV.setVisibility(View.GONE);
                question7Selected2IV.setVisibility(View.GONE);
    ...
    private void init(View view) {
        question7Choose1IV = view.findViewById(R.id.question7Choose1IV);
        question7Choose2IV = view.findViewById(R.id.question7Choose2IV);
        question7Selected1IV = view.findViewById(R.id.question7Selected1IV);
        question7Selected2IV = view.findViewById(R.id.question7Selected2IV);
    }
