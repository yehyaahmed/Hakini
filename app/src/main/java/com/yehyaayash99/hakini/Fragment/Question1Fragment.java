...
public class Question1Fragment extends Fragment {
    ...
    ImageView question1Choose1IV, question1Choose2IV, question1Choose3IV, question1Choose4IV,
            question1Seleted1IV, question1Seleted2IV, question1Seleted3IV, question1Seleted4IV;


    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.question1_layout, container, false);
        init(view);

        checkSelect();

        question1Choose1IV.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                QuestionsActivity.number1 = 1;
                checkSelect();
                ...
                new Handler().postDelayed(new Runnable() {
                    @Override
                    public void run() {
                        getFragmentManager().beginTransaction().replace(R.id.fragment_container, new Question2Fragment()).commit();
                    }
                }, 1000);
            }
        });

        question1Choose2IV.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                QuestionsActivity.number1 = 2;
                checkSelect();
                QuestionsActivity.positionFragment++;
                makeChangeInItems(QuestionsActivity.positionFragment);
                new Handler().postDelayed(new Runnable() {
        ...
        question1Choose3IV.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                QuestionsActivity.number1 = 3;
                checkSelect();
                QuestionsActivity.positionFragment++;
                makeChangeInItems(QuestionsActivity.positionFragment);
                new Handler().postDelayed(new Runnable() {
        ...
        question1Choose4IV.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                QuestionsActivity.number1 = 4;
                checkSelect();
                QuestionsActivity.positionFragment++;
                makeChangeInItems(QuestionsActivity.positionFragment);
                new Handler().postDelayed(new Runnable() {
    ...
    private void init(View view) {
        question1Choose1IV = view.findViewById(R.id.question1Choose1IV);
        question1Choose2IV = view.findViewById(R.id.question1Choose2IV);
        question1Choose3IV = view.findViewById(R.id.question1Choose3IV);
        question1Choose4IV = view.findViewById(R.id.question1Choose4IV);
        question1Seleted1IV = view.findViewById(R.id.question1Seleted1IV);
        question1Seleted2IV = view.findViewById(R.id.question1Seleted2IV);
        question1Seleted3IV = view.findViewById(R.id.question1Seleted3IV);
        question1Seleted4IV = view.findViewById(R.id.question1Seleted4IV);
    }

    private void checkSelect() {
        switch (QuestionsActivity.number1) {
            case 1:
                question1Seleted1IV.setVisibility(View.VISIBLE);
                question1Seleted2IV.setVisibility(View.GONE);
                question1Seleted3IV.setVisibility(View.GONE);
                question1Seleted4IV.setVisibility(View.GONE);

                QuestionsActivity.question1Result = "المرحلة الدراسية";
                break;
            case 2:
                question1Seleted1IV.setVisibility(View.GONE);
                question1Seleted2IV.setVisibility(View.VISIBLE);
                question1Seleted3IV.setVisibility(View.GONE);
                question1Seleted4IV.setVisibility(View.GONE);

                QuestionsActivity.question1Result = "دبلوم";
                break;

            case 3:
                question1Seleted1IV.setVisibility(View.GONE);
                question1Seleted2IV.setVisibility(View.GONE);
                question1Seleted3IV.setVisibility(View.VISIBLE);
                question1Seleted4IV.setVisibility(View.GONE);

                QuestionsActivity.question1Result = "بكالوريس جامعي";
                break;
            case 4:
                question1Seleted1IV.setVisibility(View.GONE);
                question1Seleted2IV.setVisibility(View.GONE);
                question1Seleted3IV.setVisibility(View.GONE);
                question1Seleted4IV.setVisibility(View.VISIBLE);

                QuestionsActivity.question1Result = "دراسات عليا";
                break;
            default:
                question1Seleted1IV.setVisibility(View.GONE);
                question1Seleted2IV.setVisibility(View.GONE);
